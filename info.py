...
PICS = (environ.get('PICS', 'https://graph.org/file/d2b4fbc10923c825b037e-ac27673bae2d6ff200.jpg https://graph.org/file/4fc1d46c8b40058b9714d-57d383f64a58acf677.jpg')).split() 
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003155061552'))  
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tomjerry:tomjerry@cluster0.oyuljsa.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
UPDATE_CHANNEL_LNK = environ.get('UPDATE_CHANNEL_LNK', 'https://t.me/+xTKKXSX80o0wNTA1')

# Auth Channels

AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1003033922040") # add multiple channels here, separated by single space
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/rulerbackup/28")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/rulerbackup/28")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/rulerbackup/28")
